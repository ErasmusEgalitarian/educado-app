...
function getMonthName(month: string): string {
  ...
  return (
    (getCurrentLanguage() === 'pt-BR' ? MONTH_NAMES_PT : MONTH_NAMES_EN)[mm] ??
    month
  )
}
              ...
              return (
                <View key={entry.userId + i}>
                  <View style={[styles.row, highlighted && styles.rowHl]}>
                    <Text
                      style={[styles.rowRank, highlighted && styles.hlText]}
                    >
                      {entry.rank}
                    </Text>
                    {entry.avatarMediaId ? (
                      <Image
                        source={{
                          uri: getImageUrl(entry.avatarMediaId),
                          headers: getAuthHeaders(token),
                        }}
                        style={[
                          styles.rowAvatar,
                          highlighted && styles.rowAvatarHl,
                        ]}
                        contentFit="cover"
                      />
                    ) : (
                      ...
                      >
                        <Text
                          style={[
                            ...
                            highlighted && styles.hlAvatarText,
                          ]}
                        >
                    ...
                    <Text
                      style={[
                        styles.rowPts,
                        highlighted && styles.hlTextRegular,
                      ]}
                    >
                      {entry.points} pts
                    </Text>
